...
const debatThemes = {
  ...
  pekerjaan: [
    "Sistem magang tidak berbayar harus dilarang sepenuhnya",
    "Pekerja harus memiliki hak untuk menolak lembur tanpa sanksi",
    "Perusahaan wajib menyediakan asuransi kesehatan untuk seluruh karyawan",
    "Usia pensiun harus diturunkan menjadi 55 tahun",
    "Pekerjaan rumah tangga harus diakui sebagai pekerjaan formal yang berupah"
  ]
};
...
function selectDebatTheme(theme) {
  ...
  spinThemeLabel.textContent = "Tema " + themeName;
...
document.getElementById("btn-back-from-topic").addEventListener("click", () => {
  if (currentType === "debat") {
    updateHeader("debat");
    showState("debatMode");
  } else {
